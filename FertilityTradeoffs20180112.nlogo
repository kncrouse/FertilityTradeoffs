...
to calculate-death
  ...
  [ if random-float 1.0 < juvenile-mortality-rate  [ set dying? true ]]
end
...
"" ""
PENS
"cell cost" 1.0 0 -13840069 true "" "if any? humans [ plot median [real-estate-cost] of households +  median [education-cost] of households ]"
...
"" ""
PENS
"# Offspring" 1.0 0 -5825686 true "" "if any? humans with [adult?] [ plot median [child-count] of humans with [ adult? ]]"
"Education" 1.0 0 -955883 true "" "if any? humans with [adult?] [ plot median [current-education] of humans with [ adult? ]]"
...
462
Real Time
Preferred Education Investment
# Offspring
0.0
10.0
0.0
...
true
false
"" "clear-plot\nask humans with [ adult? ] [ plotxy (( preferred-education-I + preferred-education-II ) / 2) child-count ]"
PENS
...
At each timestep, humans have the possibity of dying. The OFFSPRING-MORALITY-RATE parameter dictates, on average, what percentage of children will die at each time step; the ADULT-MORTALITY-RATE does the equivalent for adults.
...
2. Keeping everything else constant, how does the OFFSPRING-MORALITY-RATE affect the preferred reproductive strategy of the population?
