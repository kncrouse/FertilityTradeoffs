...
to initialize-human-no-parents
  ...
  set adult? true
  set size 1.0
  set preferred-education-I precision random-float 100 3
  set preferred-education-II precision random-float 100 3
...
file-open "FertilityTradeoffs20171010_1"</setup>
    ...
    <steppedValueSet variable="future-benefit-to-present-cost" first="0.05" step="0.05" last="2"/>
  </experiment>
  <experiment name="experiment V" repetitions="10" runMetricsEveryStep="true">
    <setup>setup
file-open "FertilityTradeoffs20171011_1"</setup>
    <go>go</go>
    <final>print-data</final>
    <steppedValueSet variable="child-mortality-rate" first="0.05" step="0.05" last="1"/>
    <enumeratedValueSet variable="adult-mortality-rate">
  ...
  <experiment name="experiment VI" repetitions="100" runMetricsEveryStep="true">
    <setup>setup
file-open "FertilityTradeoffs20171011_2"</setup>
    <go>go</go>
    <final>print-data</final>
    <steppedValueSet variable="child-mortality-rate" first="0.05" step="0.05" last="1"/>
    <enumeratedValueSet variable="adult-mortality-rate">
