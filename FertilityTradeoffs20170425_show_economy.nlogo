...
to update-economy-view
  ifelse show-economy
  [ ask humans [ set hidden? true ]
    ask patches [ set pcolor scale-color green previous-bid ( max [previous-bid] of patches ) 0 ]]
  [ ask humans [ set hidden? false ]
    ask households [ update-household ]]
end
