...
to initialize-human-no-parents
  ...
  set adult? true
  set size 1.0
  set preferred-education-I precision random-float 10 2
  set preferred-education-II precision random-float 10 2
...
to invest-in-child
  ...
  repeat floor ( funds / cost-per-education-level ) [
    ...
    if ( [current-education] of child >= (( [preferred-education-I] of child + [preferred-education-II] of child ) / 2 ) ) [ kick-out-child stop ]
  ]
end
...
to-report most-common-gene
  ...
  let gene-list sentence gene-list-I gene-list-II
...
<experiments>
  <experiment name="experiment" repetitions="10" runMetricsEveryStep="true">
    <setup>setup
file-open "FertilityTradeoffs20170920_4"</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="income-per-education-level" first="1" step="1" last="10"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
