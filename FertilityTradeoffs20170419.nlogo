...
to earn-funds
  let money1 ifelse-value ( parent1 != nobody ) [ income-per-education-level * ( 1 + [current-education] of parent1 ) ] [ 0 ]
  let money2 ifelse-value ( parent2 != nobody ) [ income-per-education-level * ( 1 + [current-education] of parent2 ) ] [ 0 ]
