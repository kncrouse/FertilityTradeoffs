...
to initialize-human
  ...
  set maximum-education random 50
...
to maintain-population-density
  ask n-of ( count humans - count patches * population-density ) humans [ make-dead ]
end
...
to increase-property
  if count children = 0 and not household-has-empty-cells [
    let me-house self
...
to invest-in-children
  if count children = 0 and any? cells with [ resident = nobody ] [
    ask one-of cells with [ resident = nobody ] [ make-human [parents] of myself ]]
  ask children [ update-education ( [funds] of myself / count [children] of myself ) ]
  set funds 0
end
...
to update-household
  ...
  ask children [ set color [color] of myself - 2 ]
...
to earn-money-and-invest
  ...
  ask house [ set funds [ money] of myself ]
  set money 0
end
...
to make-adult
  set adult? true
  ask [parents] of house [ set child-count child-count + 1 ]
  move-out-of-house
  setup-new-house
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [maximum-education] of humans"
